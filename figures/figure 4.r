...
plot(X, log(chnk$RecPerSpawn[subset]), col = "grey30", xlab="Spawners", ylab="log(R/S)", 
  main = "Copper River Chinook", lwd=2, cex=1.2, type="b")
...
plot(X, log(coghill$RecPerSpawn[subset]), col = "grey30", xlab="Spawners", ylab="log(R/S)", main = "Coghill Lake sockeye", lwd=2, cex=1.2, type="b")
subset = which(eshamy$BroodYear%in%X)
plot(X, log(as.numeric(eshamy$RecPerSpawn[subset])), col = "grey30", xlab="Spawners", ylab="log(R/S)", main = "Eshamy Lake sockeye", lwd=2, cex=1.2, type="b")
subset = which(copper$BroodYear%in%X)
plot(X, log(copper$RecPerSpawn[subset]), col = "grey30", xlab="Spawners", ylab="log(R/S)", main = "Copper River sockeye", lwd=2, cex=1.2, type="b")
...
plot(X, log(pink$RecPerSpawn[subset]), col = "grey30", xlab="Spawners", ylab="log(R/S)", main = "PWS pink", lwd=2, cex=1.2, type="b")
...
plot(X, log(herring$RecPerSpawn[subset]), col="grey30", xlab="Spawning biomass (mt)", ylab="log (age 3 recruits / SSB)", main = "PWS herring", cex=1.2, lwd=2, type="b")
