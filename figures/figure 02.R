...
pdf("Figure 1b - recruits and total return_FINAL.pdf")
...
plot(salm$ReturnYear, salm$CopperChinook.totalrun, xlab="", ylab="Abundance", main="Copper Chinook", type="b", lwd=2, ylim=ylims, xlim=xlims)
...
plot(salm$ReturnYear, salm$PWSPink.totalrun, xlab="", ylab="Abundance", main="PWS pink", type="b", lwd=2, ylim=ylims, xlim=xlims)
lines(c(1989,1989),c(0,1.0e20),col="red")
...
plot(salm$ReturnYear, salm$CopperSockeye.totalrun, xlab="", ylab="Abundance", main="Copper sockeye", type="b", lwd=2, ylim=ylims, xlim=xlims)
lines(c(1989,1989),c(0,1.0e20),col="red")
...
plot(salm$ReturnYear, salm$EshamySockeye.totalrun, xlab="",ylab="Abundance",main="Eshamy sockeye",type="b", lwd=2, ylim=ylims, xlim=xlims)
lines(c(1989,1989),c(0,1.0e20),col="red")
...
plot(salm$ReturnYear, salm$CoghillSockeye.totalrun, xlab="",ylab="Abundance",main="Coghill sockeye",type="b", lwd=2, ylim=ylims, xlim=xlims)
lines(c(1989,1989),c(0,1.0e20),col="red")
...
plot(1980:2010, preFishery, xlab="",ylab="Biomass",main="PWS herring",type="b",lwd=2, ylim=ylims, xlim=xlims)
lines(c(1989,1989),c(0,1.0e20),col="red")
lines(herring$BroodYear, herring$BroodYearSB,main="PWS herring",type="b",lwd=2, col='grey50')

legend('topright', c("Total run", "Spawners"), bty='n', lwd=2, col=c("black","grey50"))
