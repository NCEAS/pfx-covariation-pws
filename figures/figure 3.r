...
plot(chnk$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Copper River Chinook", lwd=2, cex=1.6)
...
plot(coghill$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Coghill Lake sockeye", lwd=2, cex=1.6)

Y = log(as.numeric(eshamy$RecPerSpawn[subset])) # log(R/S)
plot(eshamy$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Eshamy Lake sockeye", lwd=2, cex=1.6)

Y = log(as.numeric(copper$RecPerSpawn[subset])) # log(R/S)
plot(copper$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Copper River sockeye", lwd=2, cex=1.6)
...
plot(pink$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "PWS pink", lwd=2, cex=1.6)
...
plot(herring$BroodYearSB[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawning biomass (mt)", ylab="log (age 3 recruits / SSB)", main = "PWS herring", cex=1.6, lwd=2)
