...
plot(chnk$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Copper River Chinook")
...
plot(coghill$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Coghill Lake sockeye")

Y = log(as.numeric(eshamy$RecPerSpawn[subset])) # log(R/S)
plot(eshamy$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Eshamy Lake sockeye")

Y = log(as.numeric(copper$RecPerSpawn[subset])) # log(R/S)
plot(copper$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Copper River sockeye")
...
plot(pink$Escapement[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawners", ylab="log (R/S)", main = "Prince William Sound pink")
...
plot(herring$BroodYearSB[subset], Y, col = rgb(colSeq,colSeq,colSeq, 255, maxColorValue=255), xlab="Spawning biomass", ylab="log (age 3 recruits / SSB)", main = "Prince William Sound herring")
